...
class DistributionLinks(ChildBaseStream):
    ...
    def get_url_endpoint(self, parent_obj=None):
        ...
        # store survey_id as instance attr; get_records reads it to satisfy the Qualtrics API requirement
    ...
    def get_records(self):
        ...
        try:
            ...
            LOGGER.warning("Skipping distribution_links for %s: API returned 500 (not a link distribution)", self.url_endpoint)
    ...
    def _make_probe_path(self, parent_record):
        ...
        return f"{path}?surveyId={survey_id}" if distribution_id and survey_id else path if distribution_id else ""
